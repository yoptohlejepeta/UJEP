...
poptavka = [0.1, 0.02, 0.03, 0.05, 0.07, 0.09, 0.11, 0.13, 0.14, 0.12, 0.07, 0.04, 0.02, 0.01]
n = 14 # pocet hodnot
...
# poptavka = np.array([random.choices(np.arange(0, 14), weights=poptavka) for i in range(n*k)])
# print(poptavka)
